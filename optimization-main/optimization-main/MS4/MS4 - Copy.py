...
class GeneticAlgorithm:
    def __init__(self, n_pop=50, max_iter=20, p_elite=0.1, p_crossover=0.8, p_mutation=0.1,
                ...
                for j in range(len(child1[i].u) - 1):
                    ...
                    if j == len(child1[i].u) - 2:
                        ...
                        while True:
                            ...
                            if flag or (child1[i].is_velocity_valid(j + 1) and child2[i].is_velocity_valid(j + 1)):
                                break
            if f == 10:
                child1 = make_feasible(child1)
                child2 = make_feasible(child2)
